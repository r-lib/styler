...
* cache styled expressions for speed (GitHub development version). 
  See [`help("caching")`](https://styler.r-lib.org/reference/caching.html) to 
  learn more.
...
This was just the tip of the iceberg. To learn more about custoization options 
with the tidyverse style guide, see
