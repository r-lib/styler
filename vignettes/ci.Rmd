...
- Limitations for the roxygenize hook:
  ...
  - There is a [timeout of 120s for building a hook environment](https://github.com/pre-commit-ci/runner-image/issues/93#issuecomment-922505301), 
    ...
    hook (if you package has many dependencies), so you had to disable the 
    roxygenize hook.

**Customization:**

Please see the documentation of [pre-commit.ci](https://pre-commit.ci/) on how
to skip hooks, whether or not to auto-fix problems etc.
