...
- RStudio Addins for styling the active file, styling the current
  ...
  [`help("styler_addins")`](https://styler.r-lib.org/reference/styler_addins.md).

Beyond that, styler can be used through other tools documented in the
[`vignette("third-party-integrations")`](https://styler.r-lib.org/articles/third-party-integrations.md).
Let’s get started.
...
(e.g. [`style_file()`](https://styler.r-lib.org/reference/style_file.md))
...
[`style_text()`](https://styler.r-lib.org/reference/style_text.md) for
details.
...
[`vignette("strict")`](https://styler.r-lib.org/articles/strict.md). For
`styler >= 1.2` alignment in function calls is detected and preserved so
...
[`help("stylerignore", package = "styler")`](https://styler.r-lib.org/reference/stylerignore.md).
...
RStudio), typing
[`styler::cache_info()`](https://styler.r-lib.org/reference/cache_info.md)
and then confirming the creation of a permanent cache is sufficient.
Please refer to
[`help("caching")`](https://styler.r-lib.org/reference/caching.md) for
more information. The cache is by default dependent on the version of
styler which means if you upgrade, the cache will be re-built. Also, the
cache takes literally 0 disk space because only the hash of styled code
is stored.
