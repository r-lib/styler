...
[`create_pos_ids()`](https://styler.r-lib.org/dev/reference/create_pos_ids.md),
[`validate_new_pos_ids()`](https://styler.r-lib.org/dev/reference/validate_new_pos_ids.md)
