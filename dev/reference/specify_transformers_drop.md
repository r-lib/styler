...
[`transformers_drop()`](https://styler.r-lib.org/dev/reference/transformers_drop.md)
...
[`test_transformers_drop()`](https://styler.r-lib.org/dev/reference/test_transformers_drop.md)
for some checks.
