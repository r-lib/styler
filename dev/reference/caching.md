...
and Addin). That means if you style code that already complies to a
style guide and you have previously styled that code, it will be
quicker.
...
See
[`cache_info()`](https://styler.r-lib.org/dev/reference/cache_info.md),[`cache_activate()`](https://styler.r-lib.org/dev/reference/cache_activate.md)
or
...
[`cache_clear()`](https://styler.r-lib.org/dev/reference/cache_clear.md)
or just go to the directory where the cache lives (find it with
