...
but without taking into consideration the rules for the curly-curly
...
e.g. by simplifying
[`compute_indent_indices()`](https://styler.r-lib.org/dev/reference/compute_indent_indices.md),
