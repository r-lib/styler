...
[`parse_roxygen()`](https://styler.r-lib.org/dev/reference/parse_roxygen.md)
...
- transformers:
  ...
  Passed to
  [`cache_make_key()`](https://styler.r-lib.org/dev/reference/cache_make_key.md)
  to generate a key.
...
[`parse_transform_serialize_roxygen()`](https://styler.r-lib.org/dev/reference/parse_transform_serialize_roxygen.md):
...
- Every roxygen example code can have zero or more dontrun / dontshow /
  ...
  [`style_roxygen_code_example()`](https://styler.r-lib.org/dev/reference/style_roxygen_code_example.md).
...
[`style_roxygen_example_snippet()`](https://styler.r-lib.org/dev/reference/style_roxygen_example_snippet.md)
using
