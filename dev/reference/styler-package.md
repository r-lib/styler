...
- [RStudio
  Addins](https://styler.r-lib.org/dev/reference/styler_addins.md) to
  style either selected code or the active file.
...
- Lorenz Walthert <lorenz.walthert@icloud.com>
