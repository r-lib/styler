...
- [`style_dir()`](https://styler.r-lib.org/dev/reference/style_dir.md)
  ...
  now default to styling all supported file formats (`.R`, `.Rmd`,
...
- [`style_pkg()`](https://styler.r-lib.org/dev/reference/style_pkg.md)
  now excludes the auto-generated `R/cpp11.R` file
...
- Files with `.Rmarkdown` extension are now recognized as an R markdown
  ...
  and friends ([\#824](https://github.com/r-lib/styler/issues/824)).
...
- `exclude_dirs` in
  [`style_pkg()`](https://styler.r-lib.org/dev/reference/style_pkg.md)
  is now properly respected if it is a sub-directory of a directory that
  is scheduled for styling (e.g. `test/testthat/some/dir`)
...
- [`style_file()`](https://styler.r-lib.org/dev/reference/style_file.md)
  and friends gain argument `dry` to control if changes should be
  applied to files or not
  ([\#634](https://github.com/r-lib/styler/issues/634)).

- [`style_file()`](https://styler.r-lib.org/dev/reference/style_file.md)
  and friends gain argument `base_indention` (defaulting to 0) to
  control by how much the output code is indented
...
- The internal
  [`create_tree()`](https://styler.r-lib.org/dev/reference/create_tree.md)
...
the warning from
[`?style_file`](https://styler.r-lib.org/dev/reference/style_file.md)
that all style APIs apart from
[`style_text()`](https://styler.r-lib.org/dev/reference/style_text.md)
...
- [`style_pkg()`](https://styler.r-lib.org/dev/reference/style_pkg.md)
  and
  [`style_dir()`](https://styler.r-lib.org/dev/reference/style_dir.md)
  gain a new argument `exclude_dirs` to exclude directories from
  styling, by default `renv` and `packrat`. Note that the defaults won’t
...
- styler caches results of styling, so applying styler to code it has
  ...
  [`style_pkg()`](https://styler.r-lib.org/dev/reference/style_pkg.md)
  is run but only a few files have changed since the last styling or
  when using the [styler pre-commit
  ...
  [`?caching`](https://styler.r-lib.org/dev/reference/caching.md) for
...
- [`style_file()`](https://styler.r-lib.org/dev/reference/style_file.md)
  now correctly styles multiple files from different directories. We no
...
- [`style_file()`](https://styler.r-lib.org/dev/reference/style_file.md)
  and friends do not write content back to a file when styling does not
...
- [`style_pkg()`](https://styler.r-lib.org/dev/reference/style_pkg.md),
  [`style_dir()`](https://styler.r-lib.org/dev/reference/style_dir.md)
  and the Addins can now style `.Rprofile`, and hidden files are now
  also styled ([\#530](https://github.com/r-lib/styler/issues/530)).
...
- Users can now control style configurations for styler Addins
  ...
  `Set style` Addin. See
  [`?styler::styler_addins`](https://styler.r-lib.org/dev/reference/styler_addins.md)
  for details.
...
- [`style_pkg()`](https://styler.r-lib.org/dev/reference/style_pkg.md)
  now also styles the “demo” directory by default
